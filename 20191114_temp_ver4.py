...
# 入力画像を回転させ、それに対してテンプレートマッチングを試すことで解決することはできないだろうか？
...
def main():
    FileName = "left"
    # 入力画像とテンプレート画像をで取得
    img_input = cv2.imread("../../vm_part_img/IMG_3188_{}.jpg".format(FileName))
    ...
    cv2.imwrite("./output/output_rotate_input_{}_{}.jpg".format(angle,FileName), gray_rotate)
    ...
    cv2.imwrite("./output/img_rotate_{}_{}.jpg".format(angle,FileName), img_input)
    draw_line(pt,img_input)
