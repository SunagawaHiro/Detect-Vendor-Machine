...
def get_button_line_points(s_x_y, maxid, ht, wt):
    P1 = []
    P2 = []
    P3 = []
    count = 0
...
def main(): #=====================================
    ...
    print("maxid[0][0] = ",maxid[0][0])
    print("maxid[0][1] = ",maxid[0][1])
    print("maxid[0][2] = ",maxid[0][2])    
    
    print("ht = ",ht)    
    if len(maxid) >= 1:
        P1,P2,P3 = get_button_line_points(s_x_y,maxid,ht,wt)
