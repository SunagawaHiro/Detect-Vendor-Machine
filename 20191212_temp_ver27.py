...
def main(): #=====================================================================================    
    ...
    os.makedirs(new_dir_path_recursive, exist_ok=True)
    cv2.imwrite("{}/ikiti_ijou_{}_{}_{}.jpg".format(new_dir_path_recursive,max_btn_nums_scl[1],FileName,threshold), img_input)    
    ...
    new_dir_path_recursive = './auto_output/{}/{}/peak_graph'.format(datetime.date.today(),FileName)
    os.makedirs(new_dir_path_recursive, exist_ok=True)
